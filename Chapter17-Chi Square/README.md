...
![table3_que.png](./imgs/table3_que.png)
...
6. بعضی از والدین بچه های تیم west bay متوجه یک الگویی شده اند، به نظر میرسد که یک رابطه بین عدد روی پیراهن هر بچه و پست ورزشی آن ها وجود دارد. این والدین تصمیم گرفتند که چیزی را که می بینند را ثبت کنند. داده فرضی در پایین آمده است. یک آزمون خی-دو اجرا کنید برای اینکه نشان دهید آیا شک والدین که یک رابطه بین عدد روی پیراهن و پست ورزشی هر بچه وجود دارد درست است. خی-دو و p_value خود را گزارش دهید.

![table6_que.png](./imgs/table6_que.png)



7. درست/غلط: توزیع خی-دو با ۲ درجه آزادی میانگین بزرگتری از توزیع خی-دو با ۱۲ درجه آزادی دارد.
8. درست/غلط: آزمون خی-دو اکثر اوقات رابطه معنادار بین دو متغیر پیوسته را آزمون میکند.
9. درست/غلط: تصور کنید که میخواهید نشان دهید که اگر چرخنده نشان داده شده اریب است. شما ۵۰ بار این را می چرخانید و می نویسید که چند بار هر عقربه در کجا قرار می گیرید. شما فرض صفر را در سطح 0.05 رد می کنید و تعیین می کنید که این چرخنده اریب است اگر شما مقدار خی-دو 7.82 یا بالاتر محاسبه کنید.
...
پژوهش نمره SAT و معدل.

10. به این سوالات جواب بدین تا نشان دهید که آیا نمره SAT ریاضی توزیع نرمال دارد. شاید بخواهید که اول مقادیر را استاندارد کنید.
	1. اگر این داده ها به صورت نرمال توزیع شده باشند، چه مقداری را  برای هر بخش  انتظار دارید. (i) کوچکتر از ۱ انحراف معیار پایینتر از میانگین (ii) بین میانگین و یک انحراف معیار پایین تر (iii) بین میانگین و یک انحراف معیار بالای میانگین (iv) بزرگتر از یک ۱ انحراف معیار بالای میانگین؟
	2. چه تعداد مقدار واقعا در هر بخش وجود دارد؟
	3. آزمون خی-دو را اجرا کنید تا نشان دهید آیا نمره SAT ریاضی به صورت نرمال توزیع شده اند بر اساس مقادیر مورد انتظار و مقادیر مشاهده شده.

پژوهش رژیم و سلامتی.

یک آزمون خی-دو پیرسون انجام دهید تا نشان دهید که آیا رابطه ای بین رژیم و خروجی وجود دارد. خی-دو و p_value را گزارش دهد و نتیجه را اعلام کنید.


سوالات بعدی از پژوهش ARTIST آمده است.

![artist](./imgs/artist.png)


12. یک پژوهش اعضای یک کلینک پزشکی کسانی که  گزارش داده بودند و کسانی که گزارش نداده بودند با یک نمونه گیری تصادفی از هم جدا و با هم مقایسه کرد. این پژوهش کسانی که گزارش داده بودند را به دو زیرگروه تقسیم کردند، کسانی که راجع به نحوه درمان شکایت کرده بودند و کسانی که شکایت آنها درمانی نبود. اینجا داده های جمع کلی هر گروه و تعداد کسانی که داوطلبانه کلینیک پزشکی را ترک کرده بودند، یک جدول دو طرفه بسازید. این دیتاها را تحلیل کنید تا ببینید که آیا رابطه ای بین شکایت (خیر، بله-درمانی،بله-غیردرمانی) و خروج از کلینیک (بله، خیر) وجود دارد.

![table12.png](./imgs/table12.png)




13. تصور کنید که شما باور دارید که یک رابطه ای بین رنگ چشم فرد و جایی که دوست دارد در کلاس بشیند وجود دارد. شما تصمیم میگیرید که به صورت تصادفی یک نمونه از اشخاص بگیرید و یک آزمون مستقل بودن خی-دو اجرا کنید. جدول دو طرفه به چه شکل خواهد بود؟ از اطلاعات استفاده کنید تا یک جدولی را بسازید، و مطمئن شوید که برای هر مرحله نام گذاری کنید.
14. زمین‌شناسی قطعاتی از سنگ آهک را در ابعاد نمونه‌های دستی از منطقه‌ای خاص جمع‌آوری می‌کند. ارزیابی کیفی بافت و رنگ این نمونه‌ها نتایج زیر را به همراه دارد. آیا شواهدی مبنی بر وجود ارتباط میان رنگ و بافت در این سنگ‌های آهک وجود دارد؟ پاسخ خود را توضیح دهید.

 ![[Screenshot 2026-09-17 at 03.41.32.png]]



15. تصور کنید که از دانشجویان خواسته شده است که علاقه سیاسی آنها (دموکرات، جمهوری خواه و مستقل) و طعم مورد علاقه بستنی (شکلاتی، وانیلی یا توت فرنگی) و تصور کنید که داده ها در جدول دو طرفه زیر آمده است.
![[Screenshot 2026-09-17 at 03.44.56.png]]

- چه نسبتی از جواب دهندگان بستنی شکلاتی مورد علاقه اشان بود؟
- چه نسبتی از جواب دهندگان مستقل بودند؟
- چه نسبتی از افراد مستقل علاقه به بستنی شکلاتی داشتند؟
- چه نسبتی از کسانی که بستنی شکلاتی دوست داشتند مستقل بودند؟
- این داده را بررسی کنید و بگویید آیا رابطه ای بین پارتی سیاسی و علاقه آنها به طعم بستنی خاصی وجود دارد؟

16. انجمن ملی ورزش دانشگاهی (NCAA) در اواسط دهه ۱۹۸۰ داده‌هایی را در مورد نرخ فارغ‌التحصیلی ورزشکاران در «دسته یک» (Division I) گردآوری کرد. از میان ۲۳۳۲ مرد، ۱۳۴۳ نفر و از میان ۹۵۹ زن، ۴۴۱ نفر از دانشگاه فارغ‌التحصیل نشده بودند.
الف. یک جدول دو‌طرفه (جدول توافقی) برای بررسی رابطه میان جنسیت و فارغ‌التحصیلی تشکیل دهید.
ب. روش آزمون مناسبی را برای تحلیل رابطه میان جنسیت و فارغ‌التحصیلی مشخص کنید. آن روش را اجرا کرده و نتیجه‌گیری خود را بیان نمایید.
