...
3. خطی بودن:
	فرض می شود که رابطه بین هر متغیر پیشگو و متغیر معیار خطی است. اگر این فرض قبول نشود، سپس پیشبینی ها به صورت سیستمی زیادتر از مقادیر واقعی برای یک بردی از مقادیر بر روی یک متغیرهای پیشگو و آن ها را نسبت به هم دست کم گرفته می شوند.
